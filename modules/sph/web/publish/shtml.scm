...
(export shtml-include shtml-layout
  shtml-lines shtml-lines-if-multiple
  shtml-link shtml-links shtml-object shtml-page-mtime shtml-top-bar)
          ...
          (l (name url description)
            (if description
              (list (q p) (shtml-link url name)
                " "
                (if (list? description) (interleave (map (l a (pair (q span) a)) description) "|")
                  description))
              (list (q p) (shtml-link url name))))
          link-data))
